...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 24, 2022 at 04:02 AM
...
INSERT INTO `tabel_buyer` (`id_buyer`, `username`, `password`, `nama`, `email`, `alamat`, `no_hp`, `foto`, `salt`) VALUES
(1, 'nana', '12345', 'na jaemin', 'nana@gmail.com', 'seoul, south korea', '089876765654', 'nana.jpg', 'buyer'),
(2, '', '12345', 'biru', 'biru@gmail.com', '', '', NULL, 'admin'),
(5, '', '12345', 'ecan', 'ecan@gmail.com', '', '', NULL, '');
...
CREATE TABLE `tabel_gambar` (
  `id_gambar_produk` int(20) NOT NULL,
...
INSERT INTO `tabel_gambar` (`id_gambar_produk`, `id_produk`, `keterangan`, `gambar_produk`) VALUES
(1, 2, 'gambar 1', 'produk1.1.JPG');
...
INSERT INTO `tabel_laporan` (`id_laporan`, `nama`, `email`, `subjek`, `deskripsi`) VALUES
(1, 'nana', 'nana@gmail.com', 'Pengiriman', 'test'),
(2, 'biru', 'biru@gmail.com', 'Pengiriman', 'pengirimanya ngadat nih'),
(5, 'nana', 'nana@gmail.com', 'transaksi', 'jalan aja');
...
INSERT INTO `tabel_order` (`id_order`, `id_buyer`, `nama_penerima`, `hp_penerima`, `provinsi`, `alamat`, `kota`, `kode_pos`, `no_order`, `ekspedisi`, `paket`, `estimasi`, `ongkir`, `berat`, `grand_total`, `total_bayar`, `status_bayar`, `status_order`, `tgl_order`, `bank`, `no_va`, `no_resi`) VALUES
(19, 1, 'taufan hidayatullah', 2147483647, 'Jawa Barat', 'ciawigebang', 'Kuningan', 45575, 'BTO11655949001', 'JNE', 'OKE', '', '10000', '600', '', '810000', 'settlement', 'Selesai', '2022-06-23 03:50:01', '', '', 'JP0019181822121');
...
INSERT INTO `tabel_order_detail` (`id_order_detail`, `no_order`, `id_barang`, `qty`, `subtotal`) VALUES
(16, 'BTO11655949001', 2, 1, '300000'),
(17, 'BTO11655949001', 3, 1, '500000');

-- --------------------------------------------------------

--
-- Table structure for table `tabel_payment_notification`
--

CREATE TABLE `tabel_payment_notification` (
...
--
-- Dumping data for table `tabel_payment_notification`
--

INSERT INTO `tabel_payment_notification` (`id_transaction`, `transaction_status`, `order_id`, `transaction_time`, `va_number`, `bank`, `transaction_id`, `payment_type`, `status_code`, `gross_amount`, `status_message`) VALUES
(5, 'pending', 'BTO11655904110', '2022-06-22 20:21:57', '106169782731', 'bca', '94ad86db-fe3e-4ffa-8b8f-cebb57c5aa45', 'bank_transfer', '201', 92000, 'Transaksi sedang diproses'),
(6, 'pending', 'BTO11655905940', '2022-06-22 20:52:34', '70012422079639311', 'Mandiri', '0072c95f-3ebc-4bbc-b673-90b3f4e59c27', 'echannel', '201', 313000, 'Transaksi sedang diproses'),
(7, 'pending', 'BTO11655946869', '2022-06-23 08:14:36', '106169990382', 'bca', 'e10877a4-c2fc-4250-9f16-5c076e4d37e5', 'bank_transfer', '201', 313000, 'Transaksi sedang diproses'),
(8, 'pending', 'BTO11655948419', '2022-06-23 08:40:47', '061006030217756', 'Permata', '7354139b-ef32-40cf-8662-f81290948678', 'bank_transfer', '201', 413000, 'Transaksi sedang diproses');
...
INSERT INTO `tabel_produk` (`id_produk`, `id_kategori`, `nama_produk`, `harga_produk`, `berat`, `gambar_produk`, `stok_produk`, `diskon`, `deskripsi`) VALUES
(1, 5, 'Pangko', '50000', '300', 'produk3-min_(1).JPG', 5, '0', 'Dibuat Tahun : April 2022\r\nBahan : Katun\r\nDibuat Oleh : Toko Yerasa\r\nJenis : Cap'),
(2, 3, 'Pangko Sisik', '300000', '300', 'produk2-min1.JPG', 10, '0', 'Dibuat Tahun : April 2022\r\nBahan : Katun\r\nDibuat Oleh : Toko Yerasa\r\nJenis : Tulis'),
(3, 4, 'Prangko Sisik', '500000', '300', 'produk1-min-min1.JPG', 4, '0', 'Dibuat Tahun : April 2022\r\nBahan : Sutra\r\nDibuat Oleh : Toko Yerasa\r\nJenis : Tulis');
...
INSERT INTO `tabel_saran` (`id_saran`, `nama`, `email`, `subjek`, `deskripsi`) VALUES
(4, 'nana', 'nana@gmail.com', 'website', 'website jelek');
...
INSERT INTO `tabel_testimoni` (`id_testimoni`, `nama`, `subjek`, `deskripsi`) VALUES
(1, 'nana', 'produk', 'bagus ya'),
(6, 'ecan', 'harga', 'harga maha;');
...
ALTER TABLE `kota`
  ADD PRIMARY KEY (`id`),
  ADD KEY `kota_province_id_index` (`province_id`);
...
--
-- Indexes for table `tabel_payment_notification`
--
ALTER TABLE `tabel_payment_notification`
...
--
ALTER TABLE `tabel_buyer`
  MODIFY `id_buyer` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tabel_gambar`
--
ALTER TABLE `tabel_gambar`
  MODIFY `id_gambar_produk` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tabel_order_detail`
  MODIFY `id_order_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `tabel_payment_notification`
--
ALTER TABLE `tabel_payment_notification`
...
--
ALTER TABLE `tabel_saran`
  MODIFY `id_saran` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tabel_testimoni`
--
ALTER TABLE `tabel_testimoni`
  MODIFY `id_testimoni` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `kota`
  ADD CONSTRAINT `kota_province_id_foreign` FOREIGN KEY (`province_id`) REFERENCES `provinsi` (`id`);
COMMIT;
