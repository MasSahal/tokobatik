<main id="main">
    ...
    <div class="container">
      <div class="row">
        <div class="col-8">
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus dolor odit voluptates in repudiandae error eos ad explicabo id. Similique quis delectus exercitationem nihil facilis molestias iusto cupiditate aperiam blanditiis!</p>
          <a href="<?= base_url('buyer/produk') ?>"><button type="button" class="btn btn-outline-secondary">Belanja Sekarang</button></a>
  ...
  <!-- <div class="row justify-content-center text-center mb-5">
          <div class="col-md-5" data-bs-aos="fade-up">
            <h2 class="section-heading"><a href="<?= base_url('blog') ?>">Lihat yang lainnya?</a></h2>
          </div>
