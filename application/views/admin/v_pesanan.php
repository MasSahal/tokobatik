      ...
      <div class="col-sm-12 scrollme">
        <table class="table  table-responsive" cellpadding="6" cellspacing="1" style="width:100%">
          ...
          foreach ($dataOrder as $items) {
            ...
            if($status_order == "0")  {$status_order = "Menunggu Pembayaran";}
            else if($status_order == "dibayar")  {$status_order = "Belum dikonfirmasi Admin";}
	          ...
	          ?>
                ...
                <td><?php echo $items->nama; ?></td>
	              ...
	              <td> <a href="<?= BASE_URL(); ?>pesanan_admin/proses_pesanan/<?= $items->no_order ?>"><i class="fa-solid fa-pencil" alt="proses pesanan"></i>  </a>
                <?php if(strtolower($items->status_order) == "selesai"){ ?> &nbsp;&nbsp;<a href="<?= BASE_URL(); ?>pesanan_admin/hapus_pesanan/<?= $items->no_order ?>"><i class="fa-solid fa-trash" alt="Hapus Pesanan"></i>  </a> <?php } ?></td>
